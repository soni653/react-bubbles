...
- [ ] Explain what a token is used for.
      ...
      A token is used for authentication when a user inputs the correct credentials.

- [ ] What steps can you take in your web apps to keep your data secure?

      You can allow users to sign in and have a token.  With that token they can then view your web pages.

- [ ] Describe how web servers work.

      Web servers serve users.  They send out the web page info when a user requests it.
